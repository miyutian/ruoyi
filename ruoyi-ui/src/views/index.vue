    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="sourcesList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="资源列表" align="center" v-if="columns[4].visible" />
...
<script>
import { listUser, getUser, delUser, addUser, updateUser, resetUserPwd, changeUserStatus,listStates,listSources,stateSources } from "@/api/system/user";
